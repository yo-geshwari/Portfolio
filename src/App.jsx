...
import { Github, Linkedin, Mail, Download, ExternalLink, Menu, X, Award, Briefcase, Code, Heart } from 'lucide-react';
...
const Portfolio = () => {
  ...
  const skills = {
    frontend: ['React', 'JavaScript', 'HTML5', 'CSS3', 'Tailwind CSS', 'Redux', 'Next.js'],
    backend: ['Node.js', 'Express', 'MongoDB', 'PostgreSQL', 'REST APIs', 'JWT Auth'],
  ...
  const projects = [
    {
      title: 'StreamVibe',
      description: 'Full-stack video sharing platform with user authentication, video upload, and streaming capabilities. Optimized for performance with CDN integration.',
      tech: ['React', 'Node.js', 'MongoDB', 'AWS S3'],
      github: '#',
      live: '#',
      impact: '10k+ requests/month'
    },
    {
      title: 'SecureAuth Pro',
      description: 'Comprehensive authentication system featuring JWT tokens, email verification, password reset, and session management with Redis caching.',
      tech: ['React', 'Express', 'JWT', 'Redis', 'bcrypt'],
      github: '#',
      live: '#',
      impact: 'Enterprise-grade security'
    },
    {
      title: 'AdminDash Analytics',
      description: 'Responsive admin dashboard with real-time data visualization, user management, and analytics. Improved load times by 40% through optimization.',
  ...
  const experience = [
    {
      ...
      period: 'Summer 2024',
      description: 'Developed responsive web components and collaborated with design team to implement UI/UX improvements.',
      achievements: ['Built 15+ reusable React components', 'Reduced page load time by 30%']
    },
    {
      role: 'Freelance Web Developer',
      company: 'Self-Employed',
      period: '2023 - Present',
      description: 'Created custom websites for small businesses and personal clients.',
      achievements: ['Delivered 8+ client projects', 'Maintained 5-star rating']
    }
  ];

  const achievements = [
    { title: 'Smart India Hackathon Finalist', year: '2024', category: 'Hackathon' },
    { title: 'React Developer Certification', year: '2024', category: 'Certification' },
    { title: 'Full-Stack Development Course', year: '2023', category: 'Course' },
    { title: 'Best Web Project Award', year: '2023', category: 'Award' }
  ];
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
              ...
              {['home', 'about', 'skills', 'projects', 'experience', 'contact'].map((item) => (
                <button
                  ...
                  className={`capitalize transition-colors ${
                    activeSection === item ? 'text-pink-500 font-semibold' : 'text-gray-600 hover:text-pink-400'
                  }`}
                >
                  {item}
                </button>
            ...
            <button className="md:hidden" onClick={() => setIsMenuOpen(!isMenuOpen)}>
              {isMenuOpen ? <X className="text-pink-500" /> : <Menu className="text-pink-500" />}
            </button>
          </div>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible.home ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-pink-400 via-rose-400 to-pink-500 bg-clip-text text-transparent">
              Hi, I'm Yogeshwari
            </h1>
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              B.Tech CSE student passionate about building beautiful, functional web experiences.
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <button className="px-8 py-3 bg-white text-pink-500 border-2 border-pink-400 rounded-full font-semibold hover:bg-pink-50 hover:scale-105 transition-all flex items-center gap-2">
                <Download size={20} />
                Download Resume
              </button>
            </div>
            ...
            <div className="absolute bottom-20 right-10 w-32 h-32 bg-rose-200 rounded-full blur-3xl opacity-50 animate-pulse" style={{animationDelay: '1s'}}></div>
          </div>
        </div>
      </section>
          ...
          <div className={`transition-all duration-1000 ${isVisible.about ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-pink-100">
                <h3 className="text-2xl font-semibold mb-4 text-pink-500">My Journey</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  I'm a B.Tech Computer Science student with a passion for creating intuitive,
                  aesthetically pleasing web applications. What started as curiosity about how
                  websites work has evolved into a deep love for frontend development.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  I believe great web development is where technical excellence meets thoughtful
                  design. Whether it's building responsive interfaces or optimizing performance,
                  I approach every project with attention to detail and user-first thinking.
                </p>
              </div>
              
              <div className="bg-gradient-to-br from-pink-100 to-rose-100 rounded-3xl p-8 shadow-lg">
                <h3 className="text-2xl font-semibold mb-6 text-pink-600">Education</h3>
                <div className="space-y-4">
                  <div className="bg-white rounded-xl p-4 shadow-sm">
                    ...
                    <p className="text-sm text-pink-500">2022 - 2026 | CGPA: 8.5/10</p>
                  </div>
                  <div className="bg-white rounded-xl p-4 shadow-sm">
                    <h4 className="font-semibold text-gray-800">Current Focus</h4>
                    <div className="flex flex-wrap gap-2 mt-2">
                      <span className="px-3 py-1 bg-pink-100 text-pink-600 rounded-full text-sm">React</span>
                      <span className="px-3 py-1 bg-pink-100 text-pink-600 rounded-full text-sm">Full-Stack</span>
                      <span className="px-3 py-1 bg-pink-100 text-pink-600 rounded-full text-sm">UI/UX</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className={`transition-all duration-1000 ${isVisible.skills ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {Object.entries(skills).map(([category, items]) => (
                <div key={category} className="bg-white rounded-3xl p-6 shadow-lg border-2 border-pink-100 hover:border-pink-300 transition-all hover:shadow-xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 bg-gradient-to-br from-pink-100 to-rose-100 rounded-xl">
                      <Code className="text-pink-500" size={24} />
                    </div>
                    <h3 className="text-xl font-semibold capitalize text-gray-800">{category}</h3>
                  </div>
          ...
          <div className={`transition-all duration-1000 ${isVisible.experience ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="space-y-8">
              {experience.map((exp, index) => (
                <div key={index} className="bg-white rounded-3xl p-8 shadow-lg border-l-4 border-pink-400 hover:shadow-xl transition-all">
                  ...
                  <div className="space-y-2">
                    {exp.achievements.map((achievement, i) => (
                      <div key={i} className="flex items-start gap-2">
                        <Heart className="text-pink-400 mt-1 flex-shrink-0" size={16} />
            ...
            <div className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {achievements.map((achievement, index) => (
                  <div key={index} className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-6 shadow-md hover:shadow-lg transition-all border border-pink-100">
            ...
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-pink-100">
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-pink-400 to-rose-400 text-white rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition-all"
                >
                  Send Message
                </button>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-pink-100">
                <div className="flex justify-center gap-6">
                  <a href="#" className="p-3 bg-gradient-to-br from-pink-100 to-rose-100 rounded-full hover:shadow-lg hover:scale-110 transition-all">
      ...
      <footer className="py-8 px-4 bg-white border-t border-pink-100">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-gray-600">
            © 2024 Priya Sharma. Built with React & Tailwind CSS
          </p>
